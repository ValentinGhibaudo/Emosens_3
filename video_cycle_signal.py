...
def cycle_signal_frames_vabsolue(sub, **p):
    
    sub_folder = 'Cycle_Signal_Video_2_vabsolue'
...
def test_cycle_signal_frames_vabsolue():
    sub = 'P11'
    ds = cycle_signal_frames(sub, **cycle_signal_frames_params)
    print(ds)

cycle_signal_frames_vabsolue_job = jobtools.Job(precomputedir, 'cycle_signal_frames_vabsolue_', cycle_signal_frames_params, cycle_signal_frames_vabsolue)
jobtools.register_job(cycle_signal_frames_vabsolue_job)
...
def make_video_cycle_signal_vabsolue(sub):
...
def make_all_videos_vabsolue():
    for sub in subject_keys:
        print(sub)
        make_video_cycle_signal_vabsolue(sub) 
    

if __name__ == '__main__':
    # test_cycle_signal_frames()
    # test_cycle_signal_frames_vabsolue()
    # compute_all()
